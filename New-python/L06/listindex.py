...
animals = ['cat','dog','rabbit','hamster','dog','parrot','dog','rabbit','hamster','dog','parrot','dog','rabbit','hamster','dog','parrot','dog','rabbit','hamster','dog','parrot','dog','rabbit','hamster','dog','parrot','dog','rabbit','hamster','dog','parrot'] 
first_dog_index = animals.index('dog')
print(f'the first occurrence of "dog" is at index: {first_dog_index}')
